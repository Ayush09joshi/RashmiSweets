            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="pin mt-6 flex space-x-3 text-sm">
                ...
                <button
                  ...
                  class="flex ml-auto text-white bg-red-600 border-0 py-2 px-6 focus:outline-none hover:bg-red-700 rounded"
                >
                  Check
                </button>
              </div>
              ...
              <div class="flex">
                ...
                <button
                  ...
                  class="flex ml-8 md:ml-16 text-white bg-red-600 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-red-700 rounded"
                >
                  Buy Now
                </button>
                <button
